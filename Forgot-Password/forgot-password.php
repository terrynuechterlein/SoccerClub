...
session_start();
  ...
  if($_SERVER['REQUEST_METHOD'] == "POST")
  {
    ...
    if($con->affected_rows) {
      ...
      Click <a href="http://localhost/SoccerClub/Reset-Password/reset-password.php?token=$token">here</a> to reset your password.
      ...
      try{
        ...
        header("refresh:5;url=../SignUp/signup.php");  // Redirects to signup.php
      }
      catch (Exception $e){
